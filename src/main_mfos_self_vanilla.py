...
parser.add_argument("--exp-name", type=str, default="runs/mfos_ppo_ppo_vanilla")
parser.add_argument("--checkpoint", type=str, default="")
parser.add_argument("--offset-action", action="store_true")
parser.add_argument("--max-episodes", type=int, default=1024)
...
if __name__ == "__main__":
    ...
    name = "%s_%s" % (args.exp_name, args.offset_action)
